...
class Onboarding2: UIViewController {
    ...
    func setupViews() {
        ...
        textLabel.text = "Simple invest in fund, stocks,\nand accumulate"
        ...
        imageView.image = UIImage(named: "Onboarding2.png")
        ...
        let ellipsesView = EllipsesView2(frame: CGRect(x: nextButton.center.x - 20, y: nextButton.frame.minY - 20, width: 40, height: 8))
