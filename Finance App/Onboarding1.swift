...
class Onboarding1: UIViewController {
    ...
    func setupViews() {
        ...
        textLabel.text = "Simple way to manage your\ninvestment"
        ...
        imageView.image = UIImage(named: "Onboarding1.png")
        ...
        let ellipsesView = EllipsesView1(frame: CGRect(x: nextButton.center.x - 20, y: nextButton.frame.minY - 20, width: 40, height: 8))
